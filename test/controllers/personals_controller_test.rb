...
class PersonalsControllerTest < ActionController::TestCase
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post :create, personal: { content: @personal.content, name: @personal.name, position: @personal.position, title: @personal.title }
    end
  ...
  test "should update personal" do
    patch :update, id: @personal, personal: { content: @personal.content, name: @personal.name, position: @personal.position, title: @personal.title }
    assert_redirected_to personal_path(assigns(:personal))
  end
