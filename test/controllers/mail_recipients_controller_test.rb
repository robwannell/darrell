...
class MailRecipientsControllerTest < ActionController::TestCase
  ...
  test "should create mail_recipient" do
    assert_difference('MailRecipient.count') do
      post :create, mail_recipient: { email: @mail_recipient.email, mailer: @mail_recipient.mailer, name: @mail_recipient.name }
    end
  ...
  test "should update mail_recipient" do
    patch :update, id: @mail_recipient, mail_recipient: { email: @mail_recipient.email, mailer: @mail_recipient.mailer, name: @mail_recipient.name }
    assert_redirected_to mail_recipient_path(assigns(:mail_recipient))
  end
