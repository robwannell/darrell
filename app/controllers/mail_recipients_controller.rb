  ...
  def create
    ...
    respond_to do |format|
      if @mail_recipient.save
        format.html { redirect_to @mail_recipient, notice: 'Mail recipient was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @mail_recipient.update(mail_recipient_params)
        format.html { redirect_to @mail_recipient, notice: 'Mail recipient was successfully updated.' }
